...
namespace MyTodo.ViewModels
{
    class MainViewModel : ObservableObject
    {
        public MainViewModel()
        {
            ...
            MenuModels.Add(new MenuModel() { IconFont = "\xe635", BackColor = "#FF3E8E6C", Title = "我的一天",Display=false });
            MenuModels.Add(new MenuModel() { IconFont = "\xe6b6", BackColor = "#FFAC395D", Title = "重要"});
            MenuModels.Add(new MenuModel() { IconFont = "\xe6e1", BackColor = "#836FFF", Title = "已计划日程"});
            MenuModels.Add(new MenuModel() { IconFont = "\xe614", BackColor = "#9400D3", Title = "已分配给你"});
            MenuModels.Add(new MenuModel() { IconFont = "\xe755", BackColor = "#FFD700", Title = "任务"});
            //设置默认值
